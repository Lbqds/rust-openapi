...
impl CallTxScriptResult {
    pub fn new(returns: Vec<models::Val>, gas_used: i32, contracts: Vec<models::ContractState>, tx_inputs: Vec<String>, tx_outputs: Vec<models::Output>, events: Vec<models::ContractEventByTxId>, debug_messages: Vec<models::DebugMessage>) -> CallTxScriptResult {
        CallTxScriptResult {
            returns,
            gas_used,
            contracts,
