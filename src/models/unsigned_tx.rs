...
pub struct UnsignedTx {
    ...
    #[serde(rename = "inputs")]
    pub inputs: Vec<models::AssetInput>,
    #[serde(rename = "fixedOutputs")]
    pub fixed_outputs: Vec<models::FixedAssetOutput>,
}

impl UnsignedTx {
    pub fn new(tx_id: String, version: i32, network_id: i32, gas_amount: i32, gas_price: String, inputs: Vec<models::AssetInput>, fixed_outputs: Vec<models::FixedAssetOutput>) -> UnsignedTx {
        UnsignedTx {
            tx_id,
            version,
            network_id,
